          ...
          <div class="curl-info">
            ...
            <div class="curl-command-group">
              ...
              <p><strong>✨ Ultra-simple!</strong> Just post to the root URL - as simple as it gets!</p>
               ...
               <div class="curl-command-container">
                 <code class="curl-command">curl -s https://blob.zip/api/upload-script | bash -s "/path/to/file.mov"</code>
                 <button class="copy-curl-btn" onclick="copyToClipboard('curl -s https://blob.zip/api/upload-script | bash -s \\"/path/to/file.mov\\"')">📋</button>
               </div>
               
               <h5>Example:</h5>
               <div class="curl-command-container">
                 <code class="curl-command">curl -s https://blob.zip/api/upload-script | bash -s "/Users/snow/Downloads/Screen Recording 2025-07-24 at 4.13.56 PM (4).mov"</code>
                 <button class="copy-curl-btn" onclick="copyToClipboard('curl -s https://blob.zip/api/upload-script | bash -s \\"/Users/snow/Downloads/Screen Recording 2025-07-24 at 4.13.56 PM (4).mov\\"')">📋</button>
               </div>
