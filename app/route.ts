          ...
          <div class="curl-info">
            ...
            <div class="curl-command-group">
              ...
              <p><strong>✨ Ultra-simple!</strong> Just post to the root URL - as simple as it gets!</p>
               ...
               <div class="curl-command-container">
                 <code class="curl-command">curl -s https://blob.zip/upload | bash -s "/path/to/file.mov"</code>
                 <button class="copy-curl-btn" onclick="copyToClipboard('curl -s https://blob.zip/upload | bash -s \\"/path/to/file.mov\\"')">📋</button>
               </div>
